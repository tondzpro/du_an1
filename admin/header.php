...
<div id="mySidenav" class="sidenav">
  ...
  <a href="index.php?act=add_sp">Quản lý đơn hàng</a>
  <a href="index.php?act=addsp">Quản lý kho hàng</a>
  <a href="index.php?act=add_bl">Quản lý bình luận</a>
  <a href="index.php?act=add_dm">Quản lý hóa đơn</a>
  <a href="index.php?act=dskh">Quản lý người dùng</a>
  <a href="index.php?act=add_dm">Thống kê</a>
</div>
